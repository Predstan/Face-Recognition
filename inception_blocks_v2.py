...
def inception_block_1a(X):
    ...
    X_pool = ZeroPadding2D(padding=((5, 6), (5, 6)), data_format='channels_first')(X_pool)
...
def inception_block_1b(X):
    ...
    X_pool = Activation('relu')(X_pool)
    X_pool = ZeroPadding2D(padding=(7, 7), data_format='channels_first')(X_pool)
...
def inception_block_2a(X):
    ...
    X_pool = fr_utils.conv2d_bn(X_pool,
                           ...
                           cv1_filter=(1, 1),
                           padding=(2, 2))
    X_pool = ZeroPadding2D(padding=((1, 2), (1, 2)), data_format='channels_first')(X_pool)
...
def inception_block_3a(X):
    ...
    X_pool = fr_utils.conv2d_bn(X_pool,
                           ...
                           cv1_filter=(1, 1),
                           padding=(1, 1))
    X_pool = ZeroPadding2D(padding=((1, 1), (1, 1)), data_format='channels_first')(X_pool)
    X_1x1 = fr_utils.conv2d_bn(X,
